...
This project is indexed by GitNexus as **9router** (18084 symbols, 28133 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
