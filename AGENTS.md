...
This project is indexed by GitNexus as **9router** (18041 symbols, 28115 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
